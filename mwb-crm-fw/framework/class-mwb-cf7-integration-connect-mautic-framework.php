...
if ( ! class_exists( 'Mwb_Cf7_Integration_Connect_Framework_New' ) ) {
	wp_die( 'Mwb_Cf7_Integration_Connect_Framework_New does not exists.' );
}
 ...
 */
class Mwb_Cf7_Integration_Connect_Mautic_Framework extends Mwb_Cf7_Integration_Connect_Framework_New {
	...
	/**
	 * Main Mwb_Cf7_Integration_Connect_Mautic_Framework Instance.
	 *
	 * Ensures only one instance of Mwb_Cf7_Integration_Connect_Mautic_Framework is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @return Mwb_Cf7_Integration_Connect_Mautic_Framework - Main instance.
	 */
	...
	public function get_mautic_link( $object, $sf_id = false ) {
		...
		$mautic_url = get_option( 'mwb-' . $this->crm_slug . '-cf7-redirect-url' );
		$link       = $sf_id;
